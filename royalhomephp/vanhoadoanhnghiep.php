...
<body>
    ...
    <div class="row" id="vanhoadoanhnghiep" style="margin-top: 105px; margin-bottom: 20px;">
        <div class="col-9">
            <div class="intro-gioithieu">
                <div class="intro-gt" style="padding-top: 20px; width: 1200px;">
                    ...
                    <li class="breadcrumb-item"><a href="vanhoadoanhnghiep.php">Văn hóa doanh nghiệp</a></li>
                    </ol>
                    </nav>
                    </div>
            </div>
            <hr>
            <p style="margin-top: 10px ; font-weight: 700; font-size: 30px; text-transform: uppercase;"><img src="./assets/img/logo2.png" alt="">Văn hóa doanh nghiệp</p>
            <hr>
                <p style="font-weight: 700; font-size: 17px;">văn hóa doanh nghiệp tại Royalhome Việt Nam</p>
                <p>Sự lớn mạnh và thành công của RoyalHome trong hơn 5 năm qua là thành quả cũng như tâm huyết của tất cả các thành viên trong công ty. Chúng tôi luôn nỗ lực xây dựng một môi trường làm việc khuyến khích sự sáng tạo, thúc đẩy được tinh thần tập thể, nơi mà mọi thành viên luôn được thể hiện khả năng và kiến thức của mình một cách hiệu quả đối với một tập thể.</p>
                <img style="width:90%" src="./assets/img/vhdn1.jfif" alt="">
                <p>Mọi thành viên đều được phát triển và đào tạo năng lực một cách chuyên nghiệp thông qua các lớp học kỹ năng tay nghề, cách quản lý công việc nhằm phục vụ tốt nhất để thúc đẩy được kinh doanh cho công ty.</p>
                <img style="width:90%" src="./assets/img/vhdn2.jpg" alt="">
               <p>Bên cạnh đó, dưới sự chỉ đạo sáng suốt của ban lãnh đạo để các thành viên của công ty luôn đi đúng hướng và phát triển được bản thân nhằm đưa công ty lên một tầm cao mới cho sự nghiệp phát triển trong tương lai.</p>
        </div>
        <div class="col-3">
