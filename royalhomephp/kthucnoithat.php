...
<head>
    ...
    <title>Kiến thức nội thất</title>
...
<header>
    ...
    <div class="intro-gioithieu" style="margin-top: 105px;">
        <div class="intro-gt" style="padding-top: 20px; width: 1200px;">
            ...
            <li class="breadcrumb-item"><a href="kthucnoithat.php">Kiến thức nội thất</a></li>
            </ol>
            </nav>
            </div>
    </div>
    <div class="container" style="width: 1170px;">
        <h4><img src="./assets/img/logo2.png" alt="">KIẾN THỨC NỘI THẤT</h4>
        <hr>
        <div class="row">
                <?php
                        require "../admin/config.php";
                        $sql = "select * from tbl_news where Cate_ID = '17' ";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<a href='news_detail.php?news_id=".$row["News_ID"]."'><img src='".$row["Image"]."' >";
                                echo "<h2>".$row["News_Name"]."</h2>";
                                echo "<h3>".$row["Time"]."</h3>";
                                echo "<p>".$row["Descrip_Demo"]."</p>";
                                echo "</a>";
                                echo "<hr>";
                                echo "</div>";
                            }
