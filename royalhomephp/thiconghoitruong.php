...
<head>
    ...
    <title>Thi công hội trường</title>
...
<body>
    ...
    <div class="backgroundbt" style="margin-top: 105px;" >
        ...
        <div class="intro-gioithieu">
            <div class="intro-gt" style="padding-top: 20px; width: 1200px;">
                ...
                <li class="breadcrumb-item"><a href="thiconghoitruong.php">Thi công hội trường</a></li>
                </ol>
                </nav>
                </div>
        </div>
    ...
    <div id="content-vp" style="height: 1430px;">
        <div class="row">
            <h2>THI CÔNG CÔNG TRÌNH THƯƠNG MẠI - HỘI TRƯỜNG</h2>
            <hr>
            <?php
                require "../admin/config.php";
                $sql = "select * from tbl_structures where Cate_ID = '11'";
