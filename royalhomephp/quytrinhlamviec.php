...
<header>
    ...
    <div class="intro-gioithieu" style="margin-top: 105px;">
        <div class="intro-gt" style="padding-top: 20px; width: 1100px;">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php">Trang chủ</a></li>
            <li class="breadcrumb-item"><a href="tintuc.php">Tin tức</a></li>
            <li class="breadcrumb-item"><a href="quytrinhlamviec.php">Quy trình làm việc</a></li>
            </ol>
            </nav>
            </div>
    </div>
    <div class="container qtrinh" style="width: 1170px;">
        <h4><img src="./assets/img/logo2.png" alt="">QUY TRÌNH LÀM VIỆC</h4>
        <hr>
        <div class="row">
            <div class="col-6">
                <a style="font-size: 23px;" href="">Quy trình làm việc của Thiết kế nội thất Royalhome Việt Nam</a><br>
            </div>
            <div class="col-3">
                <a href="">Thi công & Quyết toán</a><br>
                <a href="">Hợp đồng & Thiết kế</a><br>
            </div>
            <div class="col-3">
                <a href="">Quyết toán & Báo giá Thi Công</a><br>
                <a href="">Gặp gỡ & Khảo sát</a><br>
            </div>
        </div><hr>
        <div class="row">
            <div class="col-6">
                <a href="">Gặp gỡ & Khảo sát</a>
                <p>07/07/2017</p>
            </div><hr><br>
        </div>
    </div>
