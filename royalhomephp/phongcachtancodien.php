...
<head>
    ...
    <title>Phong cách tân cở điển</title>
    ...
    <div class="backgroundbt" style="margin-top: 105px;" >
        <div class="intro-gioithieu">
            <div class="intro-gt" style="padding-top: 20px; width: 1170px;">
                ...
                <li class="breadcrumb-item"><a href="phongcachtancodien.php">Phong cách tân cổ điển</a></li>
                </ol>
                </nav>
                </div>  
        </div>
            ...
            <div id="content-vp" style="width: 1100px;">
                <div class="row">
                    <p style="font-weight: bold;">Phong cách tân cổ điển luôn là sự lựa chọn hàng đầu trong thiết kế biệt thự những ưu điểm của phong cách này. Những chi tiết điêu khắc tinh xảo cùng nét nghệ thuật trên những mảng tường trần, hay hình khối cân đối không hề cầu kỳ, rườm rà đã tạo nên phong cách quý tộc, vua chúa, đẳng cấp, sang trọng. RoyalHome luôn tạo ra những sản phẩm riêng biệt, độc đáo, tiện nghi và chất lượng nhất.</p>
                    <h2>PHONG CÁCH TÂN CỔ ĐIỂN</h2>
                    <hr>
                    <?php
                        require "../admin/config.php";
                        $sql = "select * from tbl_structures where Cate_ID = '15'";
