    ...
    <div class="backgroundbt" style="margin-top: 105px;">
        ...
        <div class="intro-gioithieu">
            <div class="intro-gt" style="padding-top: 20px; width: 1200px;">
                ...
                <li class="breadcrumb-item"><a href="congtrinhthicong.php">Công trình đã thi công</a></li>
                </ol>
                </nav>
                </div>
        </div>
    </div>
    <p style="width: 1200px;margin: 0 auto; font-weight: 700; padding-bottom: 30px;">Bằng tình yêu và sự trân trọng dành cho quý khách hàng, bằng tình yêu và tâm huyết gửi vào mỗi công trình, RoyalHome đã cho ra được hàng loạt tác phẩm nghệ thuật danh giá. Mỗi công trình mang một vẻ đẹp riêng, một phong cách riêng, suy cho cùng tất cả đều hoàn hảo, đều chứa đựng hết tâm tư, mong muốn của khách hàng. Với sự sáng tạo không ngừng, RoyalHome luôn tạo ra những sản phẩm riêng biệt, độc đáo, tiện nghi và chất lượng nhất.</p>
    <div class="content23" style=" margin-bottom: 50px;margin-top: 10px; text-align: center;">
        <a style="text-decoration: none; color: black; font-size: 25px;font-weight: 600;padding-bottom: 15px;" href="">CÔNG TRÌNH ĐÃ THI CÔNG</a>
        
    </div>
    <div class="container" style="width: 1170px; margin-bottom: 30px;">
    <hr>
            <div class="row">
            <?php
                        require "../admin/config.php";
                        $sql = "select * from tbl_structures where Cate_ID = '8'";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<a href=''><img src='".$row["Image"]."' class='d-block w-100'></a>";
                                echo "<a href=''>".$row["Struc_Name"]."</a>";
                                echo "</div>";
                            }
                        } 
                        else {
