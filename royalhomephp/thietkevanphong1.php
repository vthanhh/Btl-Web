...
<head>
    ...
    <title>Thiết kế văn phòng</title>
...
<header>
    ...
    <div class="backgroundbt" style="margin-top: 105px;" >
        ...
        <div class="intro-gioithieu">
            <div class="intro-gt" style="padding-top: 20px; width: 1200px;">
                ...
                <li class="breadcrumb-item"><a href="thietkevanphong.php">Thiết kế văn phòng</a></li>
                </ol>
                </nav>
                </div>
        </div>
    ...
    <div id="content-vp">
        <div class="row">
            <p style="font-weight: bold;">Văn phòng làm việc là nơi gắn liền với sự hình thành và phát triển của công ty, doanh nghiệp. Là nơi để các CBNV cống hiến, làm việc và đột phá nên những ý tưởng lớn cho công ty. Bởi thế mà việc thiết kế văn phòng cần có sự tính toán tỉ mỉ, sáng tạo, mang đến môi trường làm việc thoải mái, thư giãn nhất cho nhân viên cũng như ban điều hành. Với sự sáng tạo không ngừng, RoyalHome luôn tạo ra những sản phẩm riêng biệt, độc đáo, tiện nghi và chất lượng nhất.</p>
            <h2>THIẾT KẾ  VĂN PHÒNG</h2>
            <hr>
            <?php
                require "../admin/config.php";
                $sql = "select * from tbl_structures where Cate_ID = '6'";
