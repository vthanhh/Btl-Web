...
<header>
    ...
    <div class="container" style="width: 1300px; background-color: white;">
        <div id="price-furniture" style="margin-top: 105px;">
                ...
                <div class="content4" style="width: 1170px;">
                    <h2><img src="./assets/img/logo2.png" alt="">Dự án</h2>
                    <hr>
                </div>
                <div id="content-vp" style="width: 1100px;">
                    <div class="row">
                        <div class="col-4">
                            <a href=""><img src="./assets/img/tkbt1.jpg" class="d-block w-100" alt="..."></a>
                            <a href="">Biệt thự Vinhomes Riverside - Anh Long </a>
                        </div>
                        <div class="col-4">
                            <a href=""><img src="./assets/img/tkbt2.jpg" class="d-block w-100" alt="..."></a>
                            <a href="">Biệt Thự Long Biên - Hà Nội</a>
                        </div>
                        <div class="col-4">
                            <a href=""><img src="./assets/img/tkbt3.jpg" class="d-block w-100" alt="..."></a>
                            <a href="">Biệt thự Vinhomes Mỹ Đình Gia...
                            </a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4">
                           <a href=""><img src="./assets/img/tkbt4.jpg" class="d-block w-100" alt="..."></a> 
                            <a href="">THIẾT KẾ NỘI THẤT BIỆT THỰ LAI CHÂU</a>
                        </div>
                        <div class="col-4">
                            <a href=""><img src="./assets/img/tkbt5.jpg" class="d-block w-100" alt="..."></a>
                            <a href="">Biệt thự Vinhomes Hải Phòng </a>
                        </div>
                        <div class="col-4">
                            <a href=""><img src="./assets/img/tkbt6.jpg" class="d-block w-100" alt="..."></a>
                            <a href="">Biệt Thự Hạ Long Quảng Ninh
                            </a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4">
                           <a href=""><img src="./assets/img/tkbt7.jpg" class="d-block w-100" alt="..."></a> 
                            <a href="">Biệt thự Vinhomes Green Bay</a>
                        </div>
                        <div class="col-4">
                            <a href=""><img src="./assets/img/tkbt8.jpg" class="d-block w-100" alt="..."></a>
                            <a href="">THIẾT KẾ NỘI NGOẠI THẤT </a>
                        </div>
                        <div class="col-4">
                            <a href=""><img src="./assets/img/tkbt9.jpg" class="d-block w-100" alt="..."></a>
                            <a href="">THIẾT KẾ NỘI THẤT BIỆT THỰ THÁI BÌNH</a>
                        </div>
                    </div>
                </div>
        </div>
