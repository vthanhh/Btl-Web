...
<header>
    ...
    <div class="backgroundbt" style="margin-top: 105px;" >
        ...
        <div class="intro-gioithieu">
            <div class="intro-gt" style="padding-top: 20px; width: 1200px;">
                ...
                <li class="breadcrumb-item"><a href="smartcity.html">Vinhome Smartcity</a></li>
                </ol>
                </nav>
                </div>
        </div>
    ...
    <div class="content23" style="text-align: center; margin-bottom: 50px;margin-top: 10px;">
        <a style="text-decoration: none; color: black; font-size: 25px;font-weight: 600;padding-bottom: 15px; border-bottom: dashed 1px;" href="">Vinhome Smartcity</a>
    </div>

    <div class="container" style="width: 1170px; margin-bottom: 40px;">
        Không có dự án nào
    </div>
