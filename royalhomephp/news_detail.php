...
<header>
    ...
    <div class="container" style="width: 1170px;">
        <h3><img src="./assets/img/logo2.png" alt="">TIN TỨC</h3>
		<hr>
            <div class="detail" style="margin-bottom: 100px;">
                    <?php
                        ...
                        if(isset($_GET["news_id"]))
                        {
                            ...
                            $sql = "select * from tbl_news,tbl_category where tbl_news.Cate_ID = tbl_category.Cate_ID AND News_ID='".$news_id."'";
                            ...
                            // output data of each row
                                while($row = mysqli_fetch_assoc($result)) {
                                    echo "<div class='text_1'>";
                                    echo "<h4>".$row["News_Name"]."</h4>";
                                    echo "<p>".$row["Time"]." - ".$row["Cate_Name"]."</p>";
