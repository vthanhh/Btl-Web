            ...
            <div id="content-vp">
                <div class="row">                    
                    <?php
                        ...
                        if(isset($_GET["struc_id"]))
                        {
                            $struc_id = $_GET["struc_id"];
                            $sql = "select * from tbl_structures,tbl_category where tbl_structures.Cate_ID = tbl_category.Cate_ID AND Struc_ID='".$struc_id."'";
