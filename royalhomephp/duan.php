...
<body>
   ...
   <header>
    ...
    <div class="backgroundbt" style="margin-top: 105px;" >
        ...
        <div class="navi">   
            <ul>
                ...
                <li><a href=""  style="color:rgb(255, 204, 51);">ROYALHOME PLUS</a></li>
            </ul>
        </div> 
        <div class="intro-gioithieu">
            <div class="intro-gt" style="padding-top: 20px; width: 1200px;">
                ...
                <li class="breadcrumb-item"><a href="duan.html">Vincom Ocean Park</a></li>
                </ol>
                </nav>
                </div>
        </div>
    ...
    <div class="content23" style="text-align: center; margin-bottom: 50px;margin-top: 10px;">
        <a style="text-decoration: none; color: black; font-size: 25px;font-weight: 600;padding-bottom: 15px; border-bottom: dashed 1px;" href="">Vincom Ocean Park</a>
    </div>
    <div class="container" style="margin-bottom: 20px;width: 1170px;">
        <div id="carouselExampleIndicators" class="carousel slide">
            <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="row">
                    <div class="col-4 item_3" style="padding-bottom: 10px;">
                        <a href=""><img src="./assets/img/da1.jpg" class="d-block w-100" alt="..."></a>
                        <a href="" style="padding-top: 4px;">Ảnh thực tế căn hộ mẫu 2PN+1wc tại Vinhome Ocean Park </a>
                    </div>
                    <div class="col-4 item_3" style="padding-bottom: 10px;">
                        <a href=""><img src="./assets/img/da2.jpg" class="d-block w-100" alt="..."></a>
                        <a href=""> Căn hộ 2 phòng ngủ +1 với 2wc 62,9m2 </a>
                    </div>
                    <div class="col-4 item_3" style="padding-bottom: 10px;">
                        <a href=""><img src="./assets/img/da3.jpg" class="d-block w-100" alt="..."></a>
                        <a href="">Căn hộ 1 phòng ngủ + 1 với 1wc, diện tích 42.9m2</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="carousel-item active">
                <div class="row">
                    <div class="col-4" style="padding-bottom: 10px;">
                        <a href=""><img src="./assets/img/da4.jpg" class="d-block w-100" alt="..."></a>
                        <a href="">CĂN HỘ 2 PHÒNG NGỦ 1WC 54,9M2 Trẻ trung</a>
                    </div>
                    <div class="col-4" style="padding-bottom: 10px;">
                        <a href=""><img src="./assets/img/da5.jpg" class="d-block w-100" alt="..."></a>
                        <a href=""> Căn hộ 3 phòng ngủ + 2Wc, diện tích 75.1m2</a>
                    </div>
                    <div class="col-4" style="padding-bottom: 10px;">
                        <a href=""><img src="./assets/img/da6.jpg" class="d-block w-100" alt="..."></a>
                        <a href="">Căn hộ 2 phòng ngủ 1Wc, diện tích 54,9m2</a>
                    </div>
                </div>
            </div>
        </div>
        <div id="carouselExampleIndicators" class="carousel slide" >
            ...
            <div class="carousel-item active">
                <div class="row">
                    <div class="col-4" style="padding-bottom: 10px;">
                        <a href=""><img src="./assets/img/da7.jpg" class="d-block w-100" alt="..."></a>
                        <a href="">Căn Studio 28m2 với phong cách thiết kế hiện đại</a>
                    </div>
                    <div class="col-4" style="padding-bottom: 10px;">
                        <a href=""><img src="./assets/img/da8.jpg" class="d-block w-100" alt="..."></a>
                        <a href="">Căn hộ Studio 28m2 Tại S2.18 đa dụng</a>
                    </div>
                </div>
            </div>
        </div>
