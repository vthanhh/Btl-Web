...
<header>
    ...
    <div id="core">
        <div class="container" style="width: 1170px; margin-top: 105px;">
            <div class="intro-gioithieu">
                <div class="intro-gt" style="padding-top: 20px; width: 1200px;">
                    ...
                    <li class="breadcrumb-item"><a href="giatricotloi.html">Giá trị cốt lõi</a></li>
                    </ol>
                    </nav>
                    </div>
            </div>
            <div class="row">
                <div class="col-9">
                    <p style="margin-top: 20px ; font-weight: 700; font-size: 30px; text-transform: uppercase;"> <img src="./assets/img/logo2.png" alt="">Giá trị cốt lõi</p>
                    <hr>
                    <p style="font-weight: 700; font-size: 15px; text-transform: uppercase;">Giá trị cốt lõi & triết lý hành động</p>
                    <img src="./assets/img/gtcl1.jpg" style="width: 70%; margin-bottom: 10px;" alt="">
                    <p>Giá trị cốt lõi của RoyalHome thông qua 2 tính cách quyết tâm, tự chủ, được tập thể CBNV theo đuổi như sau:</p>
                    <p style="font-weight: 700; font-size: 15px; text-transform: uppercase;">Quyết tâm
                        <ul>
                            <li>Luôn suy nghĩ về giải pháp làm sao để các hoạt động trong công việc được tốt đẹp hơn</li>
                            <li>Hoàn thành công việc trong ngày và mục tiêu trong tháng</li>
                            <li>Dám đánh đổi nguồn lực mình đang có để đạt mục tiêu</li>
                            <li>Thể hiện ra rằng tôi đang hết sức mình để đạt được mục tiêu </li>
                        </ul>
                    </p>
                    <p style="font-weight: 700; font-size: 15px; text-transform: uppercase;">Tự chủ
                        <ul>
                            <li>Tự mình giải quyết được công việc của bản thân</li>
                            <li>Không bị chi phối bởi ngoại cảnh khi thực hiện công việc và không đổ lỗi</li>
                            <li>Có trách nhiệm với lời nói, hành động</li>
                            <li>Cải tiến công việc</li>
                            <li>Khi công việc chưa hoàn thành thì luôn tìm kiếm câu trả lời</li>
                        </ul>
                    </p>
                    <img src="./assets/img/gtcl2.jpg"  style="width: 70%; margin-bottom: 10px;" alt="">
                    <p style="font-weight: 700; font-size: 15px; text-transform: uppercase;">Triết lý hành động
                        <ul>
                            <li>Nguyên tắc Win-Win </li>
                            <li>Mọi thứ đều có quy tắc, rõ ràng và minh bạch</li>
                            <li>Tôn trọng nghề nghiệp của mọi người</li>
                            <li>Nhân quả / Có trước - có sau</li>
                            <li>Luôn suy nghĩ tích cực, cầu thị để tìm giải pháp</li>
                            <li>Không bỏ cuộc khi phù hợp với mục tiêu</li>
                            <li>Luôn tỉ mỉ về việc tạo sản phẩm tốt hơn</li>
                            <li>Làm ra làm, chơi ra chơi</li>
                            <li>Có trách nhiệm với lời nói, hành động</li>
                            <li>Luôn mong muốn điều tốt hơn cho người khác</li>
                            <li>Luôn tiếp thu điều mới để đạt được mục tiêu</li>
                        </ul>
                    </p>
                </div>
                <div class="col-3">
                            <div style="margin-top: 180px;" class="menu_gt">
                                    <a href="./gioithieu1.html">Giới thiệu</a><br>
