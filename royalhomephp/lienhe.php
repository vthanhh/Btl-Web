...
<header>
    ...
    <div id="container" style="margin-top: 105px; ">
        <div class="intro-gioithieu" style="margin-top: 105px;">
            <div class="intro-gt" style="padding-top: 20px; width: 1200px;">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Trang chủ</a></li>
                <li class="breadcrumb-item"><a href="lienhe.php">Liên hệ</a></li>
                </ol>
                </nav>
                </div>
        </div>
        <h2 style="margin-left: 265px;"> <img src="./assets/img/logo2.png" alt="">Liên Hệ</h2>
        <hr>
        <div class="row">
            <div class="col-5">
                <div class="itemlh">
                    <form action="">
                        Họ và Tên * <br>
                        <input style="width:350px;" type="text" maxlength="255" placeholder="Họ và Tên"><br><br>
                        Điện thoại * <br>
                        <input style="width:350px;" type="text" maxlength="255" placeholder="Điện thoại"><br><br>
                        Email * <br>
                        <input style="width:350px" type="text" maxlength="255" placeholder="Email"><br><br>
                        Địa chỉ * <br>
                        <input style="width:350px" type="text" maxlength="255" placeholder="Địa chỉ"><br><br>
                        Nội dung * <br>
                        <textarea name="" id="" cols="45" rows="6" placeholder="Nội dung"></textarea><br><br>
                        <input type="button" onclick="alert('Gửi thành công')" value="Gửi liên hệ"><br><br>
                    </form>
                </div>
            </div>
            <div class="col-1">
            ...
            <div class="col-6">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3725.1669293655095!2d105.78466723611074!3d20.985944675767197!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ad7d840727a7%3A0xb466db7495572c1a!2sRoyalHome%20Vi%E1%BB%87t%20Nam!5e0!3m2!1svi!2s!4v1633249243061!5m2!1svi!2s" width="650" height="350"  allowfullscreen="" loading="lazy"></iframe>
                <b>ROYAL HOME</b><br>
                <p style="margin-top: 10px;"><b>Địa chỉ:</b>Số 20 LK6D – KĐT Làng Việt Kiều Châu Âu – Mỗ Lao – Hà Đông – Hà Nội</p>
                <p><b>Điện thoại:</b>0356776475</p>
            </div>
        </div>
    </div>
    <div id="footer">
