...
<body>
    ...
    <div class="backgroundbt" style="margin-top: 105px;" >
        ...
        <div class="intro-gioithieu">
            <div class="intro-gt" style="padding-top: 20px; width: 1200px;">
                ...
                <li class="breadcrumb-item"><a href="thietkenhapho.php">Thiết kế nhà phố</a></li>
                </ol>
                </nav>
                </div>
        </div>
    ...
    <div id="content-vp">
            <div class="row">
                <p style="font-weight: bold;">Để những ngôi nhà mặt phố có diện mạo mới mẻ, trẻ trung, hiện đại, tạo ra những nhịp điệu sống động cho từng tuyến phố, rất cần những bản thiết kế phối cảnh hợp lý, hình khối nhằm tạo nên công năng, khí hậu trong lành, mang đến lợi ích kinh tế, lợi ích văn hóa cho gia chủ. Thiết kế nhà phố cần có sự tính toán linh hoạt giữa kiến trúc và sự tiết kiệm về cả chi phí lẫn không gian. Với sự sáng tạo không ngừng, RoyalHome luôn tạo ra những sản phẩm riêng biệt, độc đáo, tiện nghi và chất lượng nhất.</p>
                <h2>THIẾT KẾ NHÀ PHỐ</h2>
                <hr>
                <?php
                    require "../admin/config.php";
                    $sql = "select * from tbl_structures where Cate_ID = '4'";
