...
<head>
    ...
    <title>Phong cách hiện đại</title>
    ...
    <div class="backgroundbt" style="margin-top: 105px;" >
        <div class="intro-gioithieu">
            <div class="intro-gt" style="padding-top: 20px; width: 1170px;">
                ...
                <li class="breadcrumb-item"><a href="phongcachhiendai.php">Phong cách hiện đại</a></li>
                </ol>
                </nav>
                </div>
        </div>
            ...
            <div id="content-vp" style="width: 1100px;">
                <div class="row">
                    <p style="font-weight: bold;">Thiết kế nội thất mang phong cách hiện đại sẽ rất phù hợp với không gian nhỏ hẹp, các căn hộ chung cư, biệt thự, nhà phố,...nhằm tiết kiệm tối đa diện tích và tạo nên cảm giác rộng rãi, thoải mái hơn so với căn phòng sẵn có. Phong cách hiện đại cũng ngày càng thịnh hành hơn bởi sự tiện nghi, hài hòa giữa không gian, màu sắc, sự thanh lịch, mềm mại, không cầu kỳ. Với sự sáng tạo không ngừng, RoyalHome luôn tạo ra những sản phẩm riêng biệt, độc đáo, tiện nghi và chất lượng nhất.</p>
                    <h2>PHONG CÁCH HIỆN ĐẠI</h2>
                    <hr>
                    <?php
                        require "../admin/config.php";
                        $sql = "select * from tbl_structures where Cate_ID = '13'";
