...
<body>
    ...
    <div class="backgroundbt" style="margin-top: 105px;" >
        <div class="intro-gioithieu">
            <div class="intro-gt" style="padding-top: 20px; width: 1170px;">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Trang chủ</a></li>
                <li class="breadcrumb-item"><a href="phongcach.php">Dự án</a></li>
                <li class="breadcrumb-item"><a href="phongcachadong.php">Phong cách á đông</a></li>
                </ol>
                </nav>
                </div>  
        </div>
            ...
            <div id="content-vp" style="width: 1100px;">
                <div class="row">
                    <p style="font-weight: bold;">Á đông là sự giao thoa của nhiều nền văn hóa, nó mang vẻ đẹp truyền thống nhưng lại có sự kế thừa, phát huy từ phong cách hiện đại. Phong cách Á Đông thường có màu sắc nhã nhặn kết hợp với đồ nội thất có màu sắc nổi bật hơn để làm điểm nhấn cho căn phòng. Phong cách này rất hợp với những gia chủ tinh tế và muốn gần gũi với thiên nhiên. Với sự sáng tạo không ngừng, RoyalHome luôn tạo ra những sản phẩm riêng biệt, độc đáo, tiện nghi và chất lượng nhất.</p>
                    <h2>PHONG CÁCH Á ĐÔNG</h2>
                    <hr>
                    <?php
                        require "../admin/config.php";
                        $sql = "select * from tbl_structures where Cate_ID = '14'";
