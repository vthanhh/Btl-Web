    ...
    <div class="backgroundbt" style="margin-top: 105px;" >
        ...
        <div class="intro-gioithieu">
            <div class="intro-gt" style="padding-top: 20px; width: 1200px;">
                ...
                <li class="breadcrumb-item"><a href="thietkebietthu.php">Thiết kế biệt thự</a></li>
                </ol>
                </nav>
                </div>
        </div>
            ...
            <div id="content-vp">
                <div class="row">
                    <p style="font-weight: bold;">Thiết kế nội thất biệt thự là sự kết hợp hài hòa, độc đáo giữa cổ điển hoặc phong cách hiện đại. Kiến trúc nội thất phải đảm bảo tỷ lệ phù hợp, đầy đủ công năng. Đẹp, sang trọng, đẳng cấp là những yếu tố cần có và cơ bản nhất để tạo nên một căn biệt thự đúng nghĩa. Với sự sáng tạo không ngừng, RoyalHome luôn tạo ra những sản phẩm riêng biệt, độc đáo, tiện nghi và chất lượng nhất.</p>
                    <h2>THIẾT KẾ BIỆT THỰ</h2>
                    <hr>
                    <?php
                        require "../admin/config.php";
                        $sql = "select * from tbl_structures where Cate_ID = '3'";
