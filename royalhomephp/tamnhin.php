...
<body>
   ...
   <header>
    ...
    <div class="row" id="tamnhin" style="margin-bottom: 50px;margin-top: 105px;">
        <div class="col-9">
            <div class="intro-gioithieu">
                <div class="intro-gt" style="padding-top: 20px; width: 1200px;">
                    ...
                    <li class="breadcrumb-item"><a href="giatricotloi.php">Giá trị cốt lõi</a></li>
                    </ol>
                    </nav>
                    </div>
            </div>
            <hr>
            <p style="margin-top: 10px ; font-weight: 600; font-size: 25px; text-transform: uppercase;"><img src="./assets/img/logo2.png" alt="">Tầm nhìn - xứ mệnh</p>
            <hr>
                <p style="font-weight: 700; font-size: 17px;">Tầm nhìn</p>
                <p>Trở thành một công ty thiết kế và thi công nội thất số 1 tại Việt Nam mang tầm vóc thương hiệu Quốc Tế</p>
                <img style="width:100%; margin-bottom: 10px;" src="./assets/img/tamnhin.jfif" alt="">
                <p style="font-weight: 700; font-size: 17px;">Sứ mệnh
                    <ul style="width:90%">
                        <li>Liên tục mang lại sản phẩm dịch vụ chất lượng cao, độc đáo, thời thượng, riêng biệt, sáng tạo với giá hợp lý cho khách hàng.</li>
                        <li>Xây dựng môi trường làm việc chuyên nghiệp, năng động, sáng tạo, công bằng và nhân văn, gia tăng thu nhập cho người lao động.</li>
                        <li>Tạo ra sự hài hòa giữa lợi ích xã hội và doanh nghiệp, đóng góp tích cực xu thế kiến trúc nội thất
                        </li>
                    </ul>
                </p>
        </div>
